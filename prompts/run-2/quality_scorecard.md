...
Count occurrences in your suite. Each is a Run-1-validated fragility
...
- B.1: Tests that pin a fixed expected literal (`assert sign(b"x") == b"<exact bytes>"`).  The baseline does this; Run 1 generated suites largely did not.
